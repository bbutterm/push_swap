...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/20 18:32:30 by bbutterm          #+#    #+#              #
#    Updated: 2019/04/20 20:10:21 by bbutterm         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	 ft_islower.c ft_isnum.c ft_isprint.c ft_itoa.c ft_lstnew.c ft_memalloc.c \
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
		ft_islower.o ft_isnum.o ft_isprint.o ft_itoa.o ft_lstnew.o \
